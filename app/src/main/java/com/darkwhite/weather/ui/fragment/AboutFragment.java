...
import com.darkwhite.weather.ui.activity.MainActivity;
import com.darkwhite.weather.utils.AppUtil;
import com.darkwhite.weather.utils.LocaleManager;
import com.darkwhite.weather.utils.MyApplication;
import com.darkwhite.weather.utils.SharedPreferencesUtil;
import com.darkwhite.weather.utils.ViewAnimation;
...
public class AboutFragment extends DialogFragment {
  ...
  @BindView(R.id.bangla_button)
  ExtendedFloatingActionButton banglaButton;
  ...
  private void initVariables(View view) {
    ...
    if (activity != null) {
      ...
      setTextWithLinks(view.findViewById(R.id.text_pro_info), getString(R.string.pro_info));
  ...
  @OnClick({R.id.english_button, R.id.bangla_button})
  void handleChangeLanguage(View view) {
    switch (view.getId()) {
      case R.id.english_button:
        if (currentLanguage.equals(LocaleManager.LANGUAGE_BENGALI)) {
      ...
      case R.id.bangla_button:
        if (currentLanguage.equals(LocaleManager.LANGUAGE_ENGLISH)) {
          MyApplication.localeManager.setNewLocale(activity, LocaleManager.LANGUAGE_BENGALI);
          restartActivity();
        }
        break;
    }
