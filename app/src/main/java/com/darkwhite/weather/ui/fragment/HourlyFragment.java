...
public class HourlyFragment extends DialogFragment {
  ...
  private void setVariables() {
    ...
    cardView.setCardBackgroundColor(fourDayWeather.getColor());
    ...
    tempTextView.setText(String.format(Locale.getDefault(), "%.0f°", fourDayWeather.getTemp()));
    minTempTextView.setText(String.format(Locale.getDefault(), "%.0f°", fourDayWeather.getMinTemp()));
    maxTempTextView.setText(String.format(Locale.getDefault(), "%.0f°", fourDayWeather.getMaxTemp()));
    animationView.setAnimation(AppUtil.getWeatherAnimation(fourDayWeather.getWeatherId()));
  ...
  public void setFourDayWeather(FourDayWeather fourDayWeather) {
    this.fourDayWeather = fourDayWeather;
  }
