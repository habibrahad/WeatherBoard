...
import com.darkwhite.weather.listener.OnSetApiKeyEventListener;
...
public class AppUtil {
  ...
  public static String getWeatherStatus(int weatherCode, boolean isRTL) {
    if (weatherCode / 100 == 2) {
      if (isRTL) {
        return Constants.WEATHER_STATUS_bangla[0];
      } else {
        return Constants.WEATHER_STATUS_english[0];
      }
    } else if (weatherCode / 100 == 3) {
      if (isRTL) {
        return Constants.WEATHER_STATUS_bangla[1];
      } else {
        return Constants.WEATHER_STATUS_english[1];
      }
    } else if (weatherCode / 100 == 5) {
      if (isRTL) {
        return Constants.WEATHER_STATUS_bangla[2];
      } else {
        return Constants.WEATHER_STATUS_english[2];
      }
    } else if (weatherCode / 100 == 6) {
      if (isRTL) {
        return Constants.WEATHER_STATUS_bangla[3];
      } else {
        return Constants.WEATHER_STATUS_english[3];
      }
    } else if (weatherCode / 100 == 7) {
      if (isRTL) {
        return Constants.WEATHER_STATUS_bangla[4];
      } else {
        return Constants.WEATHER_STATUS_english[4];
      }
    } else if (weatherCode == 800) {
      if (isRTL) {
        return Constants.WEATHER_STATUS_bangla[5];
      } else {
        return Constants.WEATHER_STATUS_english[5];
      }
    } else if (weatherCode == 801) {
      if (isRTL) {
        return Constants.WEATHER_STATUS_bangla[6];
      } else {
        return Constants.WEATHER_STATUS_english[6];
      }
    } else if (weatherCode == 803) {
      if (isRTL) {
        return Constants.WEATHER_STATUS_bangla[7];
      } else {
        return Constants.WEATHER_STATUS_english[7];
      }
    } else if (weatherCode / 100 == 8) {
      if (isRTL) {
        return Constants.WEATHER_STATUS_bangla[8];
      } else {
        return Constants.WEATHER_STATUS_english[8];
      }
    }
    if (isRTL) {
      return Constants.WEATHER_STATUS_bangla[4];
